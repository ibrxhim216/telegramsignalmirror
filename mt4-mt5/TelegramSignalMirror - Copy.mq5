...
// Hidden/Fixed settings (not shown to user)
string ApiServerURL = "http://127.0.0.1:3737";          // Fixed API endpoint
...
void MonitorActiveTrades()
{
   ...
   for(int i = ArraySize(activeTrades) - 1; i >= 0; i--)
   {
      ...
      {
         // Position closed or pending order not filled yet
